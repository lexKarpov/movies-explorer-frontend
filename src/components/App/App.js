...
function App() {
  ...
  function logOut() {
    setIsLogged(false)
    navigate("/")
    changeVisibleFooter(true)
  }
  function changeVisibleFooter(bool) {
    setWithFooter(bool)
  }
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/editProfile" element={<EditProfile noFooter={changeVisibleFooter} logOut={logOut} />} />
      </Routes>
      {withFooter && <Footer isLog={isLogged} pageLogin={pageLogin} />}
    </div>
  );
}
